			...
			<Fragment>
				...
				>
					<div className={classNames("rct-sidebar-content", { "sidebar-overlay-dark": isDarkSidenav, 'sidebar-overlay-light': !isDarkSidenav })}>
						<div className="site-logo" style={{backgroundColor:'white'}}>
							{/*<Link to="/" className="logo-mini" >*/}
							{/*	<img src={require('Assets/img/logoTrans.png')} className="mr-15" alt="site logo" width="35" height="35" />*/}
							{/*</Link>*/}
							<Link to="/" className="logo-normal">
								<img src={require('Assets/img/logoTrans.png')}  className="mr-15" alt="site-logo" width="65" height="60" />
							</Link>
						</div>
