...
// Users Management
const AsyncStaffManagementComponent = Loadable({
	loader: () => import("Routes/users/staff-management"),
	loading: () => <RctPageLoader />,
});


// events Management
const AsyncEventManagementComponent = Loadable({
	loader: () => import("Routes/events"),
	loading: () => <RctPageLoader />,
});

// games Management
const AsyncGameManagementComponent = Loadable({
	loader: () => import("Routes/games"),
	loading: () => <RctPageLoader />,
});

const AsyncAdsManagementComponent = Loadable({
	loader: () => import("Routes/ads"),
	loading: () => <RctPageLoader />,
});

//  role Management
const AsyncRoleManagementComponent = Loadable({
	loader: () => import("Routes/rolesPermissions/Roles"),
	loading: () => <RctPageLoader />,
});

// permissions management
const AsyncPermissionManagementComponent = Loadable({
	loader: () => import("Routes/rolesPermissions/Permissions"),
	loading: () => <RctPageLoader />,
});
...
export {
	...
	AsyncStaffManagementComponent,
	AsyncEventManagementComponent,
	AsyncGameManagementComponent,
	AsyncAdsManagementComponent,
	AsyncRoleManagementComponent,
	AsyncPermissionManagementComponent,
